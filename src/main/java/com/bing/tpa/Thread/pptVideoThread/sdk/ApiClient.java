...
import com.bing.tpa.Thread.pptVideoThread.auth.ApiKeyAuth;
import com.bing.tpa.Thread.pptVideoThread.auth.Authentication;
import com.bing.tpa.Thread.pptVideoThread.auth.HttpBasicAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://api.slidize.cloud/v1.0/slides";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
            new ServerConfiguration(
                    "https://api.slidize.cloud/v1.0/slides",
    ...
    public ApiClient() {
        init();
        initHttpClient();
        setConnectTimeout(300000);  // 5分钟
        setReadTimeout(300000);     // 5分钟
        setWriteTimeout(300000);    // 5分钟
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/24.6.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.slidize.cloud/v1.0/slides
    ...
    public Call buildCall(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        return httpClient.newCall(request);//发起请求
    }
